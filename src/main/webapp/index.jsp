...
<body style="background-color: #f7f7f7;">
	...
	out.println(conn);
	%>-->
<!--  <marquee behavior="scroll" direction="left" bgcolor="pink" behavior="scroll">Coming Soon New Update Book</marquee>-->
	<!----Start Recent Book----->
	...
	<div class="container">
					...
					<div class="card-body text-center">
						...
						<div class="row">
							<a href="view_books.jsp?bid=<%=b.getBookId()%>"
								...
								class="btn btn-danger btn-sm ml-1"><%=b.getPrice()%> TK</a>
						</div>
		...
		<!--row end-->
		<div class="text-center ml-1 mt-3">
